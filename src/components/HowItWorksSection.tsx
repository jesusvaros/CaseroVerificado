  ...
  const steps = [
    {
      ...
      text: t('home.howItWorks.step1Text'),
    },
    {
      Icon: PencilSquareIcon,
      title: t('home.howItWorks.step2Title'),
      text: t('home.howItWorks.step2Text'),
    },
    {
      Icon: HandThumbUpIcon,
      title: t('home.howItWorks.step3Title'),
      text: t('home.howItWorks.step3Text'),
    },
  ];
  ...
  return (
    <section className="w-full bg-gradient-to-b from-white to-green-50 py-16">
      <div className="mx-auto max-w-6xl px-4">
        <h2 className="mb-12 text-left text-3xl font-bold">{t('home.howItWorks.title')}</h2>
