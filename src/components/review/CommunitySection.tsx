...
const CommunitySection: React.FC<CommunitySectionProps> = ({ communityData }) => {
  if (!communityData) {
    return <p className="text-gray-600">Información no disponible</p>;
  }
    ...
    <div className="grid gap-4 md:grid-cols-2 text-[16px]">
      {communityData.neighbor_types && communityData.neighbor_types.length > 0 && (
        <div className="md:col-span-2">
          <p className="mb-2 text-[16px] font-medium text-gray-600">Tipos de vecinos</p>
      ...
      {communityData.tourist_apartments && (
        <div>
          <p className="text-[16px] font-medium text-gray-600">Apartamentos turísticos</p>
      ...
      {communityData.building_cleanliness && (
        <div>
          <p className="text-[16px] font-medium text-gray-600">Limpieza del edificio</p>
      ...
      {communityData.community_security && (
        <div>
          <p className="text-[16px] font-medium text-gray-600">Seguridad</p>
      ...
      {communityData.community_environment && communityData.community_environment.length > 0 && (
        <div className="md:col-span-2">
          <p className="mb-2 text-[16px] font-medium text-gray-600">Ambiente</p>
          <div className="flex flex-wrap gap-2">
